                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ...
                                if ($current_page == 'user_admin.php') {
                                    echo 'User';
                                } elseif ($current_page == 'products_admin.php') {
                                    echo 'Products';
                                } elseif ($current_page == 'products_details_admin.php') {
                                    echo 'Product Details';
                                } elseif ($current_page == 'orders_admin.php') {
                                    echo 'Orders';
                                } else {
                                    echo 'Dashboard';
                                }
